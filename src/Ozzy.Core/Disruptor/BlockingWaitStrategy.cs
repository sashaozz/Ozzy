...
namespace Disruptor
{
    ...
    {
        private readonly Action _onAdvanceAction;
        ...
        /// <summary>
        /// Constructor with action on cursor advance
        /// </summary>
        /// <param name="onAdvanceAction"></param>
        public BlockingWaitStrategy(Action onAdvanceAction)
        {
            _onAdvanceAction = onAdvanceAction;
        }
