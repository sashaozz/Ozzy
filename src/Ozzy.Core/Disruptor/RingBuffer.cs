...
namespace Disruptor
{
    ...
    public sealed class RingBuffer<T> : Sequencer where T : class 
    {
        ...
        /// <summary>
        /// Construct a RingBuffer with the full option set and specified starting sequence.
        /// </summary>
        ...
        public RingBuffer(Func<T> eventFactory, IClaimStrategy claimStrategy, IWaitStrategy waitStrategy, long startSequence)
            : base(claimStrategy, waitStrategy,startSequence)
        {
